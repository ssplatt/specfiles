...
%define pkg_name scipy

Summary: Scipy: Scientific Tools for Python
Name: python27-%{pkg_name}
Version: 0.12.0
...
Source0: http://prdownloads.sourceforge.net/scipy/%{pkg_name}-%{version}.tar.gz

BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)

BuildRequires: python27-numpy, python27-devel
BuildRequires: fftw-devel, blas-devel, lapack-devel, ufsparse-devel
BuildRequires: gcc-gfortran, swig
Requires: python27-numpy, python27
...
%changelog
* Tue May 21 2013 Brett Taylor <btaylor@wistar.org> - 0.12.0-1
