...
syslog messages via TCP or UDP and stores it in the database. The second 
part is a Ruby on Rails web interface that allows you to view the log messages.
...
%changelog
* Mon Apr 8 2013 Brett Taylor <btaylor@wistar.org> - 0.11.0
- Updated to 0.11.0
